              ...
              <div className="print-grid">
                {plan && (() => {
                  ...
                  const sectionDetails = {
                    ...
                    highRedZone: { title: 'High Red Zone', bgColor: 'bg-white' },
                    lowRedZone: { title: 'Low Red Zone', bgColor: 'bg-white' },
              ...
              <Dialog open={showVisibilitySettings} onOpenChange={setShowVisibilitySettings}>
                ...
                <DialogContent>
                  ...
                  <div className="grid gap-4 py-4">
                    ...
                    <div className="flex items-center justify-between">
                      <Label htmlFor="high-red-zone">High Red Zone</Label>
                      <Switch
                        id="high-red-zone"
                    ...
                    <div className="flex items-center justify-between">
                      <Label htmlFor="low-red-zone">Low Red Zone</Label>
                      <Switch
                        id="low-red-zone"
          ...
          <Card className="bg-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 auto-rows-auto gap-6 mt-6">
              {[
                ...
                { key: 'highRedZone', title: 'High Red Zone', bgColor: 'bg-red-100' },
                { key: 'lowRedZone', title: 'Low Red Zone', bgColor: 'bg-red-100' },
